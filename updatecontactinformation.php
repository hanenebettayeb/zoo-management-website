...
<?php
    ...
    if (isset($_POST["update"])) {
      ...
      $sqlUpdate = "UPDATE admintabel SET addresse = '$addresse', phone = '$phone', email = '$email'  WHERE id='$id'";
      if(mysqli_query($con,$sqlUpdate)){
          session_start();
          $_SESSION["update"] = "Contact Information Updated Successfully!";
          header("Location:View contact information.php");
      }else{
    ...
    <main class="mt-5 pt-3">
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <form action="updatecontactinformation.php" method="post"     enctype="multipart/form-data" >
            <?php
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
  //GET method:Show the data of contact
  if (!isset($_GET["id"])){
    header("location:/registration/New folder (3)/View contact information.php");
    exit;
  }
  $id = $_GET["id"];
  //read the row of the contact from data table
  $sql = "SELECT * FROM admintabel WHERE id=$id ";
