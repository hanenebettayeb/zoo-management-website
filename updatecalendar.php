<?php
    ...
    if (isset($_POST["update"])) {
      ...
      $sqlUpdate = "UPDATE calendar SET  description = '$description', startdate = '$startdate', enddate =  '$enddate' WHERE id='$id' ";
      if(mysqli_query($con,$sqlUpdate)){
          session_start();
          $_SESSION["update"] = "Event Updated Successfully!";
          header("Location:view book tickets calendar information.php");
      }else{
...
<form action="updatecalendar.php" method="POST">
<?php
...
<input type="hidden" name="id" value="<?php echo $id;?>">
             ...
             <div class="mb-3">
                ...
                <input type="datetime" class="form-control" id="startdate" name="startdate"  value="<?php echo $startdate;?>">
             </div>
             <div class="mb-3">
                <label for="enddate" class="form-label">End Date</label>
                <input tupe="datetime" class="form-control" id="enddate" name="enddate"  value="<?php echo $enddate;?>">
             </div>
