<?php
    ...
    if (isset($_POST["update"])) {
      ...
      $eventstartdate = mysqli_real_escape_string($con, $_POST["eventstartdate"]);
      $eventduration = mysqli_real_escape_string($con, $_POST["eventduration"]);
      $id = mysqli_real_escape_string($con, $_POST["id"]);
      $sqlUpdate = "UPDATE eventtabel SET eventname = '$eventname', eventstartdate = '$eventstartdate', eventduration = 
      '$eventduration' WHERE id='$id' ";
      if(mysqli_query($con,$sqlUpdate)){
          session_start();
          $_SESSION["update"] = "Event Updated Successfully!";
          header("Location:VIEW EVENTS LIST.PHP");
      }else{
...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
  ...
  $sql = "SELECT * FROM eventtabel WHERE id=$id ";
...
<input type="hidden" name="id" value="<?php echo $id;?>">
    ...
    <input type="text" class="form-control" id="eventname" name="eventname"  value="<?php echo $eventname;?>" ></div>
     <div class="mb-3">
   <label for="eventstartdate"  class="form-label"> Event Start Date</label>
    <input type="date" class="form-control" id="eventstartdate" name="eventstartdate"  value="<?php echo $eventstartdate;?>" >
   </div>
   <div class="mb-3">
   <label for="eventduration" class="form-label">Event Duration</label>
   <input tupe="text" class="form-control" id="eventduration" name="eventduration"  value="<?php echo $eventduration;?>">
  </div>
  <div class="mb-3">
