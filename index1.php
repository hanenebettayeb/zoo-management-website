        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <p><span class="text-primary me-2">#</span>Welcome To Bamboo Zoo </p>
                    <h1 class="display-5 mb-4">Why You Should Visit <span class="text-primary">Bamboo Zoo</span> Park!</h1>
                    <p class="mb-4">  Bamboo Park is a park located in the South West of Algiers, Algeria in the Saïd Hamdine district. It is located between Ben Aknoun and Hydra. It opened in 1982 in the forest of Ben</p>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="img-border">
                        <img class="img-fluid" src="images/pexels-chris-pelser-7082287.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<?php
                  ...
                  <tr>
                            ...
                            <h2 class='text-white mb-0'>$row[phone]</h2>
                            </tr> 
                            ";
                        }
                            ?>
    ...
    <div class="container">
        <div class="row g-5 mb-5 align-items-end wow fadeInUp" data-wow-delay="0.1s">
            <div class="col-lg-6">
                ...
                <h1 class="display-5 mb-0">Let`s See Our <span class="text-primary">  Bamboo Zoo</span> Awsome Animals</h1>
            </div>
        ...
        <div class="row g-4">
                        ...
                        <a class="animal-item" href="img/animal-md-1.jpg" data-lightbox="animal">
                            <div class="position-relative">
                                ...
                                <div class="animal-text p-4">
                                    ...
                                    <h5 class="text-white mb-0">Spinner</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-12">
                        <a class="animal-item" href="images/pexels-leonardo-lamas-7001947.jpg" data-lightbox="animal">
                            <div class="position-relative">
                                <img class="img-fluid" src="images/pexels-leonardo-lamas-7001947.jpg" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">Animal</p>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="row g-4">
                    <div class="col-12">
                        <a class="animal-item" href=" images/pexels-pixabay-248241.jpg" data-lightbox="animal">
                            <div class="position-relative">
                                <img class="img-fluid" src="images/pexels-pixabay-248241.jpg" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">Animal</p>
                    ...
                    <div class="col-12">
                        <a class="animal-item" href="images/pexels-francesco-ungaro-409128.jpg" data-lightbox="animal">
                            <div class="position-relative">
                                <img class="img-fluid" src="images/pexels-francesco-ungaro-409128.jpg" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">Animal</p>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <a class="animal-item" href=" images/pexels-todd-trapani-1382156.jpg" data-lightbox="animal">
                            <div class="position-relative">
                                <img class="img-fluid" src="images/pexels-todd-trapani-1382156.jpg" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">Animal</p>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="row g-4">
                    <div class="col-12">
                        <a class="animal-item" href="images/pexels-jefferson-delogo-5120043.jpg" data-lightbox="animal">
                            <div class="position-relative">
                                <img class="img-fluid" src="images/pexels-jefferson-delogo-5120043.jpg" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">Animal</p>
                                    <h5 class="text-white mb-0">Owl</h5>
                    ...
                    <div class="col-12">
                        <a class="animal-item" href="images/pexels-laura-the-explaura-3608274.jpg" data-lightbox="animal">
                            <div class="position-relative">
                                <img class="img-fluid" src="images/pexels-laura-the-explaura-3608263.jpg" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">Animal</p>
                                    <h5 class="text-white mb-0">Panda</h5>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="row g-4">
                    <div class="col-12">
                        <a class="animal-item" href="images/pexels-ardit-mbrati-14659606.jpg" data-lightbox="animal">
                            <div class="position-relative">
                                <img class="img-fluid" src="images/pexels-ardit-mbrati-14659606.jpg" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">Animal</p>
                    ...
                    <div class="col-12">
                        <a class="animal-item" href="images/pexels-petr-ganaj-4121190.jpg" data-lightbox="animal">
                            <div class="position-relative">
                                <img class="img-fluid" src="images/pexels-petr-ganaj-4121190.jpg" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">Animal</p>
                                    <h5 class="text-white mb-0">Geese</h5>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="row g-4">
                    <div class="col-12">
                        <a class="animal-item" href="images/pexels-patrice-schoefolt-7459670.jpg" data-lightbox="animal">
                            <div class="position-relative">
                                <img class="img-fluid" src="images/pexels-patrice-schoefolt-7459670.jpg" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">Animal</p>
                                    <h5 class="text-white mb-0">Bear</h5>
                    ...
                    <div class="col-12">
                        <a class="animal-item" href="images/pexels-george-desipris-2055100.jpg" data-lightbox="animal">
                            <div class="position-relative">
                                <img class="img-fluid" src="images/pexels-george-desipris-2055100.jpg" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">Animal</p>
                                    <h5 class="text-white mb-0">Tiger</h5>
    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="row g-4">
                    <div class="col-12">
                        <a class="animal-item" href="images/pexels-pixabay-208866.jpg" data-lightbox="animal">
                            <div class="position-relative">
                                <img class="img-fluid" src="images/pexels-pixabay-208866.jpg" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">Animal</p>
                                    <h5 class="text-white mb-0">Horse</h5>
                    ...
                    <div class="col-12">
                        <a class="animal-item" href="images/pexels-alex-andrews-2295744.jpg" data-lightbox="animal">
                            <div class="position-relative">
                                <img class="img-fluid" src="images/pexels-alex-andrews-2295744.jpg" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">Animal</p>
                                    <h5 class="text-white mb-0">Fox</h5>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="row g-4">
                    <div class="col-12">
                        <a class="animal-item" href="images/pexels-jean-van-der-meulen-1524628.jpg" data-lightbox="animal">
                            <div class="position-relative">
                                <img class="img-fluid" src="images/pexels-jean-van-der-meulen-1524628.jpg" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">Animal</p>
                    ...
                    <div class="col-12">
                        <a class="animal-item" href="images/pexels-pixabay-162256.jpg" data-lightbox="animal">
                            <div class="position-relative">
                                <img class="img-fluid" src="images/pexels-pixabay-162256.jpg" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">Animal</p>
                                    <h5 class="text-white mb-0">Wolf</h5>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="row g-4">
                    <div class="col-12">
                        <a class="animal-item" href="images/pexels-pixabay-60644.jpg" data-lightbox="animal">
                            <div class="position-relative">
                                <img class="img-fluid" src="images/pexels-pixabay-60644.jpg" alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">Animal</p>
                                    <h5 class="text-white mb-0">Crocodile</h5>
                    ...
                    <div class="col-12">
                        <a class="animal-item" href="images/pexels-arralyn-2402927 (1).jpg" data-lightbox="animal">
                            <div class="position-relative">
                                <img class="img-fluid" src="images/pexels-arralyn-2402927 (1).jpg"  alt="">
                                <div class="animal-text p-4">
                                    <p class="text-white small text-uppercase mb-0">Animal</p>
                                    <h5 class="text-white mb-0">Camel</h5>
                ...
                <div class="col-md-6 text-light wow fadeIn" data-wow-delay="0.5s">
                  ...
                  while($row=$result->fetch_assoc()){
                    echo "
                            ...
                            <?php
                  include "connection.php";
                  $sql = "select phone,email from admintabel";
                  $result = $con->query($sql);
                  if(!$result){
                    die("Invalid query!");
                  }
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="row g-5 mb-5 align-items-end wow fadeInUp" data-wow-delay="0.1s">
            <div class="col-lg-6">
                <p><span class="text-primary me-2">#</span>Our Map</p>
                <h1 class="display-5 mb-0">
                    Explore More About The Most Beautiful Places In  <span class="text-primary">Our Zoo</span></h1>
            </div>
        </div>
<div>
    ...
    <div class="container-fluid py-5">
        <div class="row">
            <div class="col">
                <h2 class="mb-5 lined ml-5">Map of Our  Zoo</h2>
             <div class="row">
                <div class="mb-5 lined ml-5">
                    <img src="images/bronx_zoo_map_spring-2023 (1).png" width="100%" height="100%">
                    <div class="margin-2-top">     
                  <div class="d-grid gap-2" CLASS="mb-3">
                <a  href="https://cdn.wcs.org/2023/03/30/11/19/56/b35a2059-733b-4752-8a0b-2273a3a2bf78/bronx_zoo_map_spring-2023.png"  class="btn btn-primary">Show Map Image</a></div>
           <div class="margin-3-top">  <div class="d-grid gap-2" CLASS="mb-3">
               <a   href="https://cdn.wcs.org/2023/03/30/11/28/42/498dc284-004e-4bff-9ee3-aa2588d7334e/bronx_zoo_key_spring-2023.png"  class="btn btn-info"  >Show Map Key</a></div>
                </div></div></div>
</section>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item text-center">
                    ...
                    <p> I like this zoo.Thanks for all services</p>
