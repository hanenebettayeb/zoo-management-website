...
$ourtourismtrips = stripcslashes($_POST["ourtourismtrips"]);
...
$ourtourismtrips =htmlentities (mysqli_real_escape_string($con, $_POST["ourtourismtrips"]));
       $sql = " INSERT INTO ticketsmanagement (childTickets,RegularTickets,ourtourismtrips)
        VALUES('$childTickets','$RegularTickets' ,'$ourtourismtrips')";
    mysqli_query($con,$sql);
        echo "<div class='alert alert-success'>Tickets Management successfully.</div>";
...
<li>
  ...
  <div class="collapse" id="contact">
    ...
    <main class="mt-5 pt-3">
      ...
      <form action="Ticket management.php" method="POST">
      <div class="mb-3">
        <label for="childTickets" class="form-label"> Child Tickets </label>
        <input type="text" class="form-control" id="ChildTickets"  name="childTickets"></div>
    
      <div class="mb-3">
        <label for="RegularTickets" class="form-label"> Regular Tickets </label>
        <input type="text" class="form-control" id="RegularTickets"  name="RegularTickets"></div>

        <div class="mb-3">
        <label for="ourtourismtrips" class="form-label"> Our Tourism Trips </label>
        <input type="test" class="form-control" id="RegularTickets"  name="ourtourismtrips"></div>
    
       
    <div class="d-grid gap-2" CLASS="mb-3">
      
    <button type="submit" class="btn btn-outline-success" name="submit">Tickets Informations Management</button>
    <a class='btn btn-outline-danger'  type="submit" name="Cancel" href='VIEW TICKETS MANAGEMENT LIST.php'>Cancel</a>
    </div>
        </div>
    </form>
