<?php
    ...
    if (isset($_POST["update"])) {
      ...
      $sqlUpdate = "UPDATE locationtabel SET day = '$day' , hours ='$hours' WHERE id='$id'";
      
      if(mysqli_query($con,$sqlUpdate)){
          session_start();
          $_SESSION["update"] = "Visitng Hours Updated Successfully!";
          header("Location:view visiting informations.php");
      }else{
...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
  ...
  if (!isset($_GET["id"])){
    header("location:/registration/New folder (3)/view visiting informations.php");
    exit;
  }
  $id = $_GET["id"];
  //read the row of the animals from data table
  $sql = "SELECT * FROM locationtabel WHERE id=$id ";
...
<input type="hidden" name="id" value="<?php echo $id;?>">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="day"  name="day" value="<?php echo $day;?>"></div>
                <div class="mb-3">
                <label for="hours" class="form-label">Hours </label>
                
            
                <input type="text" class="form-control" id="hours"  name="hours" value="<?php echo $hours;?>"></div>
    ...
    <!--       <DIV class="mb-3">
              <img src="785b3e20-1e5a-4052-a214-00faca974536_rw_3840.jpg" class="img-thumbnail" >
            </DIV><-->
