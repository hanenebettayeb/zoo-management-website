 ...
 <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">  Ben Aknoun Park is a park located in the South West of Algiers, Algeria in the Saïd Hamdine district. It is located between Ben Aknoun and Hydra. It opened in 1982 in the forest of Ben</p>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5 mb-5 align-items-end wow fadeInUp" data-wow-delay="0.1s">
                <div class="col-lg-6">
                    ...
                    <h1 class="display-5 mb-0">Let's Book Tickets  To Enjoy The Best Moments In Our<span class="text-primary">Bamboo</span> </h1>
                </div>
       ...
       <table class="table caption-top"   class="table-warning "  >
        ...
        <caption>Price Groupe Tickets</caption>
  ...
  <tbody>
          ...
          <button class="btn btn-danger" >You have to be logged in befor  to book tickets      <a href="visitorlogin.php" >Login here </button></div>
        </div></div></form>
   <!-- Footer Start -->
