<?php
    ...
    if (isset($_POST["update"])) {
      ...
      $ContractStartDate= mysqli_real_escape_string($con, $_POST["ContractStartDate"]);
      $ContractEndDate = mysqli_real_escape_string($con, $_POST["ContractEndDate"]);
      
      $id = mysqli_real_escape_string($con, $_POST["id"]);
      $sqlUpdate = "UPDATE employeetabel SET name = '$name', email = '$email', phone = '$phone', ContractStartDate = '$ContractStartDate' , ContractEndDate = '$ContractEndDate'   WHERE id='$id'";
...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
  ...
  $sql = "SELECT * FROM employeetabel WHERE id=$id ";
...
<input type="hidden" name="id" value="<?php echo $id;?>">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="Employeename" name="name"   value="<?php echo $name;?>" ></div>
            ...
            <div class="mb-3">
             ...
             <input type="date" class="form-control" id="ContractStartDate" name="ContractStartDate" value="<?php echo $ContractStartDate;?>" >
            </div>
            <div class="mb-3">
              <label for="ContractEndDate" class="form-label">Contract End Date</label>
              <input type="date" class="form-control" id="ContractEndDate" name="ContractEndDate" value="<?php echo $ContractEndDate;?>">
            </div>
