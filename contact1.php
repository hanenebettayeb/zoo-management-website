            ...
            <div class="row g-4 mb-5">
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                  ...
                  while($row=$result->fetch_assoc()){
                    echo "
                  <tr>
                            <h5 class='mb-0' >$row[addresse]</h5> </tr>";}
                            ?>
...
$fullname = stripcslashes(strtolower($_POST["fullname"]));
...
$message = htmlentities (mysqli_real_escape_string($con, $_POST["message"]));
        ...
        $sql = " INSERT INTO contacttabel (fullname,email,message)
        VALUES('$fullname','$email','$message') ";
        mysqli_query($con,$sql);
        echo "<div class='alert alert-success'>The message has been sent  successfully.</div>";}
...
?>
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control bg-light border-0" id="name" name="fullname" placeholder="Your Name">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100" style="min-height: 400px;">
                        ...
                        src="         https://www.google.com/maps/place/Annaba,+Algeria/@36.9137988,7.662063,12z/data=!3m1!4b1!4m6!3m5!1s0x12f007bb034e7571:0x28fddce8b255b712!8m2!3d36.897375!4d7.7500122!16zL20vMDRtN2Zo?hl=en"
    ...
    <script>
        ...
        function initMap() {
            map = new google.maps.Map(document.getElementById('map'), {
                center: { lat: 36.91751231084538, lng: 7.743432253780727 },
                zoom: 12});
				
            addMarker(map, { lat: 36.84359237607085, lng: 7.677542708183903 }, 'Annaba', "yellow");
            addMarker(map, { lat: 36.93867863752476, lng: 7.766529912538444 }, 'Viva Mall', "green");
            addMarker(map, { lat: 36.90578969128128, lng: 7.759993126031309 }, 'Bamboo Zoo', "green");
            addMarker(map, { lat: 36.8975499195069, lng: 7.7580539395250385 }, 'Mega Pizza', "red");
            addMarker(map, { lat: 36.81429243438179, lng: 7.720249181851757 }, 'Université Badji Mokhtar Pôle Sidi Amar', "green");
            addMarker(map, { lat: 36.911700516611035, lng: 7.668433541151433 }, 'Hopital Seraidi', "yellow");
            addMarker(map, { lat: 36.714358490939595, lng: 7.629310454860864 }, 'Restaurant Ain Barda', "red");
			
			 
        }

        function addMarker(map, latLng, titles, color) {
			...
			marker.addListener("click", () => {
				 window.location.href='view_calender_col.html';
			  });
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCylbVrLFgDagFbmqD4HlLy16VD__kmCiE&callback=initMap">
